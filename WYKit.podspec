#
#  Be sure to run `pod spec lint WYKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "武月洋"
  # s.authors            = { "武月洋" => "wuyueyang@druid.tech" }
  # s.social_media_url   = "http://twitter.com/武月洋"
  ...
  s.source_files  = "SwiftDemo", "SwiftDemo/**/*"
